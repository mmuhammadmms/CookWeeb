	...
	<br><br>
            ...
            <div class="mu-restaurant-menu-content">
              ...
              <div class="tab-content">
				...
				$uid = $_SESSION['uid'];
				$sql = mysqli_query($conn , "select * from recipe R, recipe_saved RS where RS.userID =  '$uid' and R.recipeID = RS.recipeID");
                              ...
                              <div class="media">
                                ...
                                <div class="media-body">
                                  ...
                                  <p><?php echo mb_strimwidth(nl2br($desc),0, 20, "...");?></p>
																	<a href="removerecipe.php?rid=<?php echo $rid;?>"><button type="button" class="btn btn-danger" >Remove </button>	</a>
